                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Phone:</label>
                                        <input value="{{ old('phone') }}" type="text" name="phone" class="form-control" placeholder="+256772471355" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('phone2') }}" type="text" name="phone2" class="form-control" placeholder="0414540200" >
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                {{--LGA--}}
                                <div class="col-md-4">
                                    <label for="lga_id">County: <span class="text-danger">*</span></label>
